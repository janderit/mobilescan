...
v0.5 (multi-page PDFs), v0.6 (loupe previews while dragging) and v0.7 (shear / perspective
correction) are implemented. Defined but not yet implemented: v0.8 (auto-detect for frame and
tone, `intent/v0.8-auto-detect.md`, "v0.5 to v0.8 decisions" section of the decisions file)
and v0.9 (pinch zoom on the image in the captured and edit views, `intent/v0.9-zoom.md`,
"v0.9 decisions" section). The repository contains the product spec (`README.md`),
...
Crop/rotate view: [back] [crop+shear|rotate] [rotate 90 right] [confirm], with loupes in the stage centre during drags. Brightness/contrast view: [back] [brightness|contrast|temperature] [grayscale toggle] [confirm].
