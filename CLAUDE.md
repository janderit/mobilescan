...
correction) and v0.8 (auto-detect for frame and tone) are implemented. Defined but not yet
implemented: v0.9 (pinch zoom on the image in the captured and edit views, `intent/v0.9-zoom.md`,
